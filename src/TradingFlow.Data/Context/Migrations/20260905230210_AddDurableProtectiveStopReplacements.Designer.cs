...
namespace TradingFlow.Data.Context.Migrations
{
    ...
    [Migration("20260905230210_AddDurableProtectiveStopReplacements")]
    partial class AddDurableProtectiveStopReplacements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradingFlow.Domain.Persistence.CandidateRecord", b =>
                {
                    ...
                    b.Property<string>("AdmissionProfileId")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("TEXT")
                        .HasColumnName("admission_profile_id");

                    b.Property<string>("AdmissionProfileVersion")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("TEXT")
                        .HasColumnName("admission_profile_version");
                    ...
                    b.Property<DateTimeOffset>("DiscoveryWindowEndUtc")
                        .HasColumnType("TEXT")
                        .HasColumnName("discovery_window_end_utc");

                    b.Property<DateTimeOffset>("DiscoveryWindowStartUtc")
                        .HasColumnType("TEXT")
                        .HasColumnName("discovery_window_start_utc");
                    ...
                    b.Property<string>("SemanticDecisionSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                        .HasColumnName("semantic_decision_sha256");

                    b.Property<string>("SetupKey")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("TEXT")
                        .HasColumnName("setup_key");
                    ...
                    b.Property<string>("StrategyContentSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("TradingFlow.Domain.Persistence.CandidateTransitionRecord", b =>
                {
                    ...
                    b.HasIndex("SemanticDecisionSha256");

                    b.HasIndex("CandidateId", "Sequence")
                        .IsUnique();

                    b.ToTable("candidate_transitions", (string)null);
                });
            ...
            modelBuilder.Entity("TradingFlow.Domain.Persistence.OrderIntentRecord", b =>
                {
                    ...
                    b.Property<string>("CandidateConsumptionEvidenceSha256")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                        .HasColumnName("candidate_consumption_evidence_sha256");

                    b.Property<Guid?>("CandidateId")
                        .HasColumnType("TEXT")
                        .HasColumnName("candidate_id");

                    b.Property<string>("CandidateSemanticDecisionSha256")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                        .HasColumnName("candidate_semantic_decision_sha256");

                    b.Property<string>("CandidateTriggeredEvidenceSha256")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                        .HasColumnName("candidate_triggered_evidence_sha256");

                    b.Property<int?>("CandidateTriggeredVersion")
                        .HasColumnType("INTEGER")
                        .HasColumnName("candidate_triggered_version");
            ...
            modelBuilder.Entity("TradingFlow.Domain.Persistence.ProtectiveStopReplacementRecord", b =>
                {
                    ...
                    b.HasIndex("AccountId", "BrokerOrderId", "StopPrice")
                        .IsUnique();
            ...
            modelBuilder.Entity("TradingFlow.Domain.Persistence.CandidateTransitionRecord", b =>
                {
                    b.HasOne("TradingFlow.Domain.Persistence.CandidateRecord", null)
                        .WithMany()
